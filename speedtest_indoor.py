...
def parse_args():
    ...
    parser.add_argument('--timeout', default=2, type=PARSER_TYPE_FLOAT,
    ...
    parser.add_argument('--theme',default=2,type=PARSER_TYPE_INT,help='Test themes for this test, 1: bus, 2: indoor, 3: outdoor')
